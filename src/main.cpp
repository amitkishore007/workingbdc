...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BlackDiamondCoin is a great asset growth coin!!";
        CTransaction txNew;
        txNew.nTime = 1503558113;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbd6d5c09c13e919e9a1781ef8d257de9efa27b225eeae6469b69ad82cb465e15"));
        block.print();
